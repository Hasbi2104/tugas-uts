...
Mudah dalam pengoperasian Cepat dalam penyajian jadwal Akurat dalam perhitungan paket umroh
...
Informasi dan Panduan RABBANI Mobile Apps menyediakan informasi lengkap tentang rute perjalanan, hotel, transportasi, dan lokasi penting di Mekah dan Madinah. Aplikasi ini juga dilengkapi dengan panduan praktis tentang ritual umroh, termasuk tata cara thawaf, sa’i, dan hal-hal lain yang perlu diperhatikan selama perjalanan.
Jadwal dan Pengingat RABBANI Mobile Apps membantu jamaah umroh mengatur jadwal ibadah dengan mudah. Aplikasi ini memberikan pengingat waktu-waktu penting seperti waktu salat, waktu thawaf, dan waktu kegiatan lainnya yang terkait dengan perjalanan umroh.
Peta Interaktif Aplikasi ini menyediakan peta interaktif yang memungkinkan jamaah umroh untuk menjelajahi Mekah dan Madinah dengan mudah. Peta ini dilengkapi dengan penunjuk arah yang jelas dan informasi tentang tempat-tempat penting seperti masjid, hotel, restoran, dan fasilitas umum lainnya.
Koneksi Komunitas RABBANI Mobile Apps juga menyediakan fitur yang memungkinkan jamaah umroh terhubung dengan sesama jamaah lainnya. Fitur ini memungkinkan mereka untuk berbagi pengalaman, tips, dan saran yang berguna selama perjalanan. Hal ini dapat memperkuat rasa persaudaraan di antara jamaah umroh dan menciptakan komunitas yang saling mendukung.
1.3. Branding
...
Sederhana
simple
Warna: ala ala skai blue Inspirasi desain: ! [gamabr] aiwa-aplikasi-mobileapp-umroh-alhijaz
2. User Story
...
3. Struktur Data
Cara membuat aneka macam bentuk grafik menggunakan mermaid.js bisa lihat di https://mermaid.js.org/syntax/entityRelationshipDiagram.html erDiagram


4. Arsitektur Sistem
Masih pake mermaid.js juga bisa lihat flowchart di https://mermaid.js.org/syntax/flowchart.html


5. Teknologi, Library, dan Framework
$(document).ready(function() { AOS.init( { // uncomment below for on-scroll animations to played only once // once: true
...
$('html, body').animate({ scrollTop: target.offset().top }, 1000, function() { // Callback after animation // Must change focus! var 
(target); $target.focus(); if ($target.is(":focus")) { // Checking if the target was focused return false; } else { $target.attr('tabindex','-1'); // Adding tabindex for elements not focusable $target.focus(); // Set focus again }; }); } } }); saya membuat aplikasi ini dengan vscode database bootstrap.min.css
...
![poto] (08e2ac26-ef23-46b0-b3ab-17a1170b53c8 ![poto] (d19b6040-c368-4892-9d5d-8be54e612682 ![poto] (46509a6d-573d-41c2-9b5b-5378ea7bcd55
